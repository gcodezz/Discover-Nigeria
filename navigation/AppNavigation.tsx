...
import FoodListScreen, {
  screenOptions as FoodListScreenOptions,
} from '../screens/Food/FoodListScreen';
...
const FoodScreenStack = () => {
  return (
    <FoodStackNavigator.Navigator>
      ...
      />
      <FoodStackNavigator.Screen name='FoodDetails' component={FoodDetailsScreen} />
    </FoodStackNavigator.Navigator>
  );
};
...
const FavTabStack = () => {
  return (
    <FavoriteTabs.Navigator>
      <FavoriteTabs.Screen name='Foods' component={FoodFavorite} />
      <FavoriteTabs.Screen name='Places' component={PlaceFavorite} />
    </FavoriteTabs.Navigator>
  );
};
...
const FavScreenStack = ({ navigation }: MusicScreenStackProps) => {
  return (
    <FavStackNavigator.Navigator>
      ...
      />
      <FoodStackNavigator.Screen name='FoodDetails' component={FoodDetailsScreen} />
      <PlacesStackNavigator.Screen name='PlaceDetails' component={PlaceDetails} />
    </FavStackNavigator.Navigator>
  );
};
...
const CultureScreenStack = () => {
  return (
    <CultureStackNavigator.Navigator>
      ...
      />
      <CultureStackNavigator.Screen name='CultureDetails' component={CultureDetailsScreen} />
    </CultureStackNavigator.Navigator>
  );
};
...
const MusicTabStack = () => {
  return (
    <MusicTabs.Navigator>
      <MusicTabs.Screen name='Playlist' component={PlaylistsScreen} />
      <MusicTabs.Screen name='Artists' component={ArtistsScreen} />
      <MusicTabs.Screen name='Year' component={YearsScreen} />
    </MusicTabs.Navigator>
  );
};
    ...
    >
      ...
      <Drawer.Screen
        ...
        options={{
          ...
          drawerIcon: () => <Icon iconName='globe' />,
        }}
      />
      <Drawer.Screen
        name='Music'
        ...
        options={{
          headerTitle: 'Music',
          drawerIcon: () => <Icon iconName='music' />,
        }}
      />
      <Drawer.Screen
        name='Places'
        ...
        options={{
          headerTitle: 'Places',
          drawerIcon: () => <Icon iconName='location' />,
        }}
      />
      <Drawer.Screen
        name='Favorites'
        ...
        options={{
          ...
          drawerIcon: () => <Icon iconName='heart' />,
        }}
      />
    </Drawer.Navigator>
  );
